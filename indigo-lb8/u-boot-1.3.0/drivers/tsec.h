...
#define MIIM_SPEED1000		0x0040  /* MSB of Speed (1000)         */
#define MIIM_FULLDPLX           0x0100  /* Full duplex                 */
#define MIIM_ANENABLE           0x1000  /* Enable auto negotiation     */
#define MIIM_SPEED100           0x2000  /* Select 100Mbps              */
...
#if 1  /* BinJou: 0812/2010 : LED control : LED 1 trun off  (BCM5461s) */
#define MIIM_LED_SELECT1     0x1C 
#define MIIM_LED_SELECT1_SHADOW     0x3400
#endif
