...
#define I2C_MINOR_ID_2       1/*Raymond. 5/14/09*/

#define I2C_DRIVER_NAME          "Quanta_LB8"
#define I2C_DEVICE_DRIVER_NAME          "Quanta_LB8_I2C"
#define PFX                     "Quanta_LB8: "
...
typedef struct
{
    ...
    struct i2c_client *client;/*Raymond. 5/14/09*/
} epfcb;
