...
#define INCLUDE_BASHSHELL /**/

/* Include shell for precompiled Haserl/Lua */
#define INCLUDE_LUACSHELL /**/

/* Include ordinary Lua shell */
#define INCLUDE_LUASHELL /**/
...
#define PACKAGE_BUGREPORT "Nathan Angelacos - nangel@users.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "haserl"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "haserl 0.9.27"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "haserl"
