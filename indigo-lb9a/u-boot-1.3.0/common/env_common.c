...
#if defined(CONFIG_FLASH_BOOTCOMMAND)
	"flash_bootcmd="	CONFIG_FLASH_BOOTCOMMAND		"\0"
#endif
#if defined(CONFIG_CFCARD_BOOTCOMMAND)
	"cfcard_bootcmd="	CONFIG_CFCARD_BOOTCOMMAND		"\0"
#endif
#endif
