...
typedef enum
{
  ...
  AT24C02_EEPROM_MB,
  AT24C02_EEPROM_DB,
  AT24C02_EEPROM_DB_SFP,
  PCA9555_EXPANDER_DB,
  PCA9546APW_SWITCH_DB,
  LAST_I2C_DEVICE
} I2C_DEVICES;
#define I2C_INVALID_ADDRESS         		(0xFF)

#define I2C_SODIMM						(0x57)
#define I2C_ADT7470_SENSOR				(0x2C)
#define I2C_DS1338_RTC					(0x68)
#define I2C_AT24C02_EEPROM_MB			(0x54)
#define I2C_AT24C02_EEPROM_DB			(0x53)
#define I2C_AT24C02_EEPROM_DB_SFP		(0x50)
#define I2C_PCA9555_EXPANDER_DB		(0x20)
#define I2C_PCA9546APW_SWITCH_DB		(0x70)
...
struct i2cAddressMapping i2c_device_adrs[] =
{
  ...
  {I2C_SODIMM,              			"SODIMM"},
  {I2C_ADT7470_SENSOR,		"ADT7470_SENSOR"},
  {I2C_DS1338_RTC, 			"DS1338_RTC"},
  {I2C_AT24C02_EEPROM_MB,		"AT24c02_EPPROM_MB"},
  {I2C_AT24C02_EEPROM_DB,		"AT24c02_EPPROM_DB"},
  {I2C_AT24C02_EEPROM_DB_SFP, 	"AT24c02_EPPROM_DB_SFP"},
  {I2C_PCA9555_EXPANDER_DB,	"PCA9555_EXPANDER_DB"},
  {I2C_PCA9546APW_SWITCH_DB, "PCA9546APW_SWITCH_DB"},
};
