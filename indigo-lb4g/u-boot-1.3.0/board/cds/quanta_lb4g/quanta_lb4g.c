...
const iop_conf_t iop_conf_tab[4][32] = {
	...
	/* PA31 */ {   1,   0,   0,   1,   0,   1   }, /* SW1_XG_RST_N */
	/* PA30 */ {   1,   0,   0,   1,   0,   1   }, /* PCI_RST_N */
	/* PA29 */ {   1,   0,   0,   1,   0,   0   }, /* CF_RST_N */
	/* PA28 */ {   1,   0,   0,   1,   0,   0   }, /* CPLD_RST_N */
	/* PA27 */ {   1,   0,   0,   1,   0,   0   }, /* TSEC_RST_N */
	/* PA26 */ {   1,   0,   0,   1,   0,   1   }, /* F_RST_N */
	/* PA25 */ {   1,   0,   0,   1,   0,   1   }, /* SOFT_RST_N */
	/* PA24 */ {   1,   0,   0,   1,   0,   1   }, /* HARD_RST_N */
	/* PA23 */ {   1,   0,   0,   0,   0,   0   }, /* CF_INSERT_N */
	/* PA22 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA21 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA20 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA19 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA18 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA17 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PA16 */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	...
	/* PB27 */ {   1,   0,   0,   1,   0,   0   }, /* STATUS_LED */
	/* PB26 */ {   1,   0,   0,   1,   0,   1   }, /* PHY_ISO_N */
	/* PB25 */ {   1,   0,   0,   1,   0,   1   }, /* MOD_RST_N */
	/* PB24 */ {   1,   0,   0,   1,   0,   1   }, /* PHY6_RST_N */
	/* PB23 */ {   1,   0,   0,   1,   0,   1   }, /* PHY5_RST_N */
	/* PB22 */ {   1,   0,   0,   1,   0,   1   }, /* PHY4_RST_N */
	/* PB21 */ {   1,   0,   0,   1,   0,   1   }, /* PHY3_RST_N */
	/* PB20 */ {   1,   0,   0,   1,   0,   1   }, /* PHY2_RST_N */
	/* PB19 */ {   1,   0,   0,   1,   0,   1   }, /* PHY1_RST_N */
	/* PB18 */ {   1,   0,   0,   1,   0,   1   }, /* SW2_XG_RST_N */
	...
	/* PC9  */ {   1,   0,   0,   0,   0,   0   }, /* MOD_ID_SEL1 */
	/* PC8  */ {   1,   0,   0,   0,   0,   0   }, /* MOD_ID_SEL0 */
	/* PC7  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC6  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC5  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC4  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC3  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC2  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC1  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
	/* PC0  */ {   0,   0,   0,   0,   0,   0   }, /* pin doesn't exist */
     },
	...
	/* PD19 */ {   1,   0,   0,   1,   0,   0   }, /* SPI_SEL_N */
	/* PD18 */ {   1,   0,   0,   1,   0,   0   }, /* SPI_CLK */
	/* PD17 */ {   1,   0,   0,   1,   0,   0   }, /* SPI_MOSI */
	/* PD16 */ {   1,   0,   0,   0,   0,   0   }, /* SPI_MISO */
