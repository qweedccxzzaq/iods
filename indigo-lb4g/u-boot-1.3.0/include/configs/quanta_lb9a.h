...
#error ("CONFIG_SPD_EEPROM is required by LB9A")
#endif
...
#else       /*LB9A EVT board issue : hardware layout swap*/
...
#define CONFIG_CFCARD_BOOTCOMMAND \
   "setenv bootargs root=/dev/ram "                                     \
   "console=ttyS0,$baudrate; "                                  \
   "ext2load ide 0:1 0x1000000 /uImage;ext2load ide 0:1 0x2000000 /uInitrd2m;ext2load ide 0:1 0x400000 /LB9A.dtb;" \
